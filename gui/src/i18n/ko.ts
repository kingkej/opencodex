...
export const ko: Record<TKey, string> = {
  ...
  "codexAuth.accountPickerOffDesc": "활성화하면 계정 선택기별 항목이 모델 선택기에 추가되어 로그아웃하지 않고도 대화에 사용할 정확한 계정을 선택할 수 있습니다. 두 번째 설정에서 일반 자동 Pool 항목을 함께 표시할지 정할 수 있습니다. 계정 지정을 비활성화해도 계정은 삭제되지 않습니다.",
  ...
  "codexAuth.accountPickerPoolModelsTitle": "자동 Pool 모델을 선택기에 유지",
  "codexAuth.accountPickerPoolModelsOffDesc": "계정 지정이 활성화된 동안에는 계정 선택기만 표시됩니다. 일반 자동 Pool 항목도 계속 사용하려면 이 설정을 켜세요.",
  "codexAuth.accountPickerPoolModelsOnDesc": "일반 Pool 모델 항목이 계정 선택기와 함께 표시됩니다. OpenCodex가 자동으로 순환하거나 장애 조치하도록 하려면 이 항목을 선택하세요.",
  "codexAuth.accountPickerPoolModelsUpdated": "자동 Pool 모델 표시 설정을 업데이트했습니다.",
  "codexAuth.accountPickerPoolModelsUpdateFailed": "자동 Pool 모델 표시 설정을 업데이트하지 못했습니다. 마지막으로 확인된 설정을 표시합니다.",
