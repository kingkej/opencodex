...
export const ru: Record<TKey, string> = {
  ...
  "codexAuth.accountPickerOffDesc": "После включения в списке моделей появляется отдельный пункт для каждого селектора аккаунта, поэтому можно явно выбрать аккаунт для разговора без выхода из системы. Дополнительная настройка определяет, останутся ли рядом обычные автоматические пункты Pool. Отключение выбора аккаунта не удаляет аккаунты.",
  ...
  "codexAuth.accountPickerPoolModelsTitle": "Оставлять автоматические модели Pool в списке",
  "codexAuth.accountPickerPoolModelsOffDesc": "Пока выбор аккаунта включён, показываются только селекторы аккаунтов. Включите эту настройку, чтобы обычные автоматические пункты Pool тоже оставались доступны.",
  "codexAuth.accountPickerPoolModelsOnDesc": "Обычные пункты моделей Pool показываются рядом с селекторами аккаунтов. Выбирайте их, когда OpenCodex должен автоматически ротировать аккаунты или переключаться при сбое.",
  "codexAuth.accountPickerPoolModelsUpdated": "Отображение автоматических моделей Pool обновлено.",
  "codexAuth.accountPickerPoolModelsUpdateFailed": "Не удалось обновить отображение автоматических моделей Pool. Показана последняя подтверждённая настройка.",
