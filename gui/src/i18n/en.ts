...
export const en = {
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "codexAuth.accountPickerOffDesc": "When enabled, the picker adds one entry per account selector, so you can choose the exact account for a conversation without logging out. A secondary setting controls whether ordinary automatic Pool entries stay visible alongside them. Turning account targeting off removes no accounts.",
  ...
  "codexAuth.accountPickerPoolModelsTitle": "Keep automatic Pool models in the picker",
  "codexAuth.accountPickerPoolModelsOffDesc": "Only account selectors are shown while account targeting is enabled. Turn this on to keep ordinary automatic Pool entries available too.",
  "codexAuth.accountPickerPoolModelsOnDesc": "Ordinary Pool model entries stay visible alongside account selectors. Choose them when you want OpenCodex to rotate or fail over automatically.",
  "codexAuth.accountPickerPoolModelsUpdated": "Automatic Pool model visibility updated.",
  "codexAuth.accountPickerPoolModelsUpdateFailed": "Could not update automatic Pool model visibility. The last confirmed setting is shown.",
