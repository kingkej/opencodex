...
export const de: Record<TKey, string> = {
  ...
  "codexAuth.accountPickerOffDesc": "Wenn aktiviert, fügt die Modellauswahl je einen Eintrag pro Kontoselektor hinzu. So kannst du ohne Abmeldung das genaue Konto für eine Unterhaltung wählen. Eine zweite Einstellung legt fest, ob die normalen automatischen Pool-Einträge daneben sichtbar bleiben. Beim Deaktivieren der Kontozielauswahl werden keine Konten entfernt.",
  ...
  "codexAuth.accountPickerPoolModelsTitle": "Automatische Pool-Modelle in der Auswahl anzeigen",
  "codexAuth.accountPickerPoolModelsOffDesc": "Bei aktivierter Kontozielauswahl werden nur Kontoselektoren angezeigt. Aktiviere dies, damit auch die normalen automatischen Pool-Einträge verfügbar bleiben.",
  "codexAuth.accountPickerPoolModelsOnDesc": "Normale Pool-Modelleinträge bleiben neben den Kontoselektoren sichtbar. Wähle sie, wenn OpenCodex automatisch rotieren oder ausweichen soll.",
  "codexAuth.accountPickerPoolModelsUpdated": "Sichtbarkeit automatischer Pool-Modelle aktualisiert.",
  "codexAuth.accountPickerPoolModelsUpdateFailed": "Die Sichtbarkeit automatischer Pool-Modelle konnte nicht aktualisiert werden. Die zuletzt bestätigte Einstellung wird angezeigt.",
